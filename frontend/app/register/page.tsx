    ...
    <div className="h-screen flex items-center justify-center">
      <div className="w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-zinc-800">
        <div className="px-6 py-4">
          ...
          <p className="mt-1 text-center text-gray-500 dark:text-gray-400">Sign up or login to account</p>
        ...
        <div className="flex items-center justify-center py-4 text-center bg-gray-50 dark:bg-zinc-700">
          ...
          <a href="/" className="mx-2 text-sm font-bold text-blue-500 dark:text-blue-400 hover:underline">Login</a>
        </div>
      </div>
    </div>
  );
